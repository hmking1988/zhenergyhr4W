sap.ui.controller("com.zhenergy.hr.view.roster.rosterDetail", {
	...
	onBeforeShow: function(evt) {
		if (evt) {
			...
			this.getView().byId("roster_person_headlike").bindElement("/EE_PERSONPHOTO_SET('" + listuserid + "')");
			this.getView().byId("rosterrenyuanxinxi").bindElement("/ER_RESUME_HEADER_SET('" + pernrid + "')");
	...
	onAfterShow: function(evt) {
		if (evt) {
			...
			var sEntityPath = "/ER_WORK_REWORD_ITEM_SET/?$filter=(Pernr eq '" + pernrid + "')&sap-language=zh_CN";
			var sEntityPath2 = "/ER_FAMILY_ITEM_SET/?$filter=(Pernr eq '" + pernrid + "')&sap-language=zh_CN";
	...
	back: function() {
		roster.app.backToPage("idrosterMasterPage");
	},
